...
export const orbControlGroups = [
  ...
  },
  {
    name: "Motion",
    fields: [
      { key: "speedMin", label: "Speed min", min: 0, max: 300, step: 5, unit: "px/s", spawn: true, pairMax: "speedMax" },
      { key: "speedMax", label: "Speed max", min: 0, max: 300, step: 5, unit: "px/s", spawn: true, pairMin: "speedMin" },
      { key: "turnRateMax", label: "Turn rate", min: 0, max: 1.5, step: 0.05, unit: "rad/s", spawn: true },
      { key: "wanderAmp", label: "Wander swing", min: 0, max: 2, step: 0.05, unit: "rad/s" },
      { key: "wanderFreqMin", label: "Wander freq min", min: 0, max: 2, step: 0.05, unit: "rad/s", spawn: true, pairMax: "wanderFreqMax" },
      { key: "wanderFreqMax", label: "Wander freq max", min: 0, max: 2, step: 0.05, unit: "rad/s", spawn: true, pairMin: "wanderFreqMin" },
      { key: "growthMax", label: "Growth", min: 0, max: 60, step: 1, unit: "px/s", spawn: true },
    ],
  },
  {
    name: "Lifecycle",
  ...
  },
  {
    name: "Cursor",
    fields: [
      { key: "influenceRadius", label: "Reach", min: 0, max: 600, step: 10, unit: "px" },
      { key: "pushForce", label: "Push force", min: -2000, max: 3000, step: 50, unit: "" },
      { key: "friction", label: "Friction", min: 0.2, max: 5, step: 0.1, unit: "/s" },
      { key: "maxPushSpeed", label: "Max speed", min: 0, max: 2000, step: 50, unit: "px/s" },
      ...
      { key: "respondMin", label: "Respond min", min: 0, max: 2, step: 0.05, unit: "", spawn: true, pairMax: "respondMax" },
      { key: "respondMax", label: "Respond max", min: 0, max: 2, step: 0.05, unit: "", spawn: true, pairMin: "respondMin" },
    ],
  },
];
